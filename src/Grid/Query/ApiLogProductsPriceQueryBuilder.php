...
/**
 * Class ApiLogProductsPriceQueryBuilder.
 */
final class ApiLogProductsPriceQueryBuilder extends AbstractDoctrineQueryBuilder
{
    /**
    ...
    public function getSearchQueryBuilder(SearchCriteriaInterface $searchCriteria): QueryBuilder
    {
        ...
        $qb->addSelect('ROUND(ps.base_price, 2) as base_price_current');
        $qb->addSelect('ROUND(ps.recommend_price, 2) as recommend_price_current');
        $qb->addSelect('ps.visibility');
    ...
    private function getQueryBuilder(array $filterValues): QueryBuilder
    {
        ...
        $qb->from($this->dbPrefix . 'api_log_products_price', 'alpp');
        ...
        foreach ($filterValues as $filterName => $filter) {
            ...
            if ('visibility' === $filterName) {
                $qb->andWhere('p.visibility = :visibility');
                $qb->setParameter('visibility', $filter);
                continue;
            }
